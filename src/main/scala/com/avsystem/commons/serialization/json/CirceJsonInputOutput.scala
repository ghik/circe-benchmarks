package com.avsystem.commons.serialization.json
...
class CirceJsonOutput(consumer: Json => Any) extends Output {
  ...
  def writeBinary(binary: Array[Byte]): Unit = throw new UnsupportedOperationException
...
class CirceJsonInput(json: Json) extends Input {
  ...
  def readBinary(): Array[Byte] = throw new UnsupportedOperationException
